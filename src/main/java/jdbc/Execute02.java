...
public class Execute02 {
    ...
    public static void main(String[] args) throws ClassNotFoundException, SQLException {
        ...
        String sql1 = "SELECT country_name FROM countries WHERE region_id = 1";// rejın id si 1 olan ulkeler den sehir adını getir
        ...
        ResultSet result1 = st.executeQuery(sql1);// executeQuery karsıdan data ckmek icin kullanılır.
